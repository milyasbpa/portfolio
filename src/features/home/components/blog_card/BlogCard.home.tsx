    ...
    >
      ...
      >
        ...
        >
          ...
          <motion.div className="absolute inset-0 rounded-2xl tablet:rounded-3xl overflow-hidden">
            <motion.div
              className={clsx(
          ...
          >
            ...
            <motion.div
              variants={contentVariants}
              className={clsx("order-1 tablet:order-2", "space-y-4")}
            >
              {/* Blog Header */}
              ...
              {/* Blog Meta Info */}
              <motion.div
                className={clsx("flex items-center gap-4", "pt-2")}
                variants={contentVariants}
              >
                <motion.div
                  className={clsx(
