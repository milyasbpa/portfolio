  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {[
            { icon: FaBookOpen, label: "Articles", value: "5+", color: "from-teal-500 to-cyan-600" },
            { icon: FaEdit, label: "Topics", value: "8+", color: "from-cyan-500 to-blue-600" },
            { icon: FaEye, label: "Readers", value: "100+", color: "from-indigo-500 to-purple-600" }
          ].map((stat, index) => (
            <motion.div
              key={index}
              variants={itemVariants}
