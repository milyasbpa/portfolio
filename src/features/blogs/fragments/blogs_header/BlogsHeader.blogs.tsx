...
export const BlogsHeader: React.FC<BlogsHeaderProps> = ({ blogCount = 0 }) => {
  return (
    <motion.header
      className={clsx(
        "sticky top-0 z-50",
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 line-clamp-1 hidden sm:block">
              Explore our collection of {blogCount} {blogCount === 1 ? 'article' : 'articles'} covering algorithms, data structures, and software development best practices
            </p>
          </div>
